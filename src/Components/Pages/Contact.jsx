  ...
  return (
    <section className="">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap ">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative mt-[70px] ml-[90px]">
          <iframe
            width="100%"
            height="100%"
            title="map"
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/3 px-6">
              ...
              <p className="mt-1 text-indigo-400">San Diego</p>
            </div>
            <div className="lg:w-2/3 px-6 mt-4 lg:mt-0">
              ...
              <p className="leading-relaxed text-indigo-400">619-804-7667</p>
            </div>
          </div>
        </div>
        <form
